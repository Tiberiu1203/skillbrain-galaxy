...
// Funcția care inversează un array și returnează unul nou
...
function reverseArray(arr) {
  ...
  function testReverseArray() {
    ...
    console.log(reverseArray(array1).join(", "));
    console.log(reverseArray(array2).join(", "));
    console.log(reverseArray(array3).join(", "));
    console.log(reverseArray(array4).join(", "));
